...
<div class="min-h-screen bg-gradient-to-br from-amber-50 to-rose-50 py-8">
    <div class="max-w-3xl mx-auto px-6">
        <!-- En-tête -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-slate-900">Modifier l'article</h1>
            <p class="text-slate-600 mt-2">Apportez les modifications nécessaires à votre article</p>
        </div>
                ...
                <div class="bg-amber-50 rounded-lg p-4 border border-amber-200">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="is_published" class="font-medium text-amber-800">Publier cet article</label>
